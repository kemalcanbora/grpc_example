...
from square_example.pb2 import calculator_pb2 as calculator__pb2
...
class CalculatorStub(object):
  ...
  def __init__(self, channel):
    ...
    """
    self.SquareRootz = channel.unary_unary(
        '/Calculator/SquareRootz',
...
def add_CalculatorServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'SquareRootz': grpc.unary_unary_rpc_method_handler(
          servicer.SquareRootz,
